...
VERBOSE_URL = False
logger = create_logger('scraper_errors.log', 'scraper_errors.log')
...
def scrape_series_data(url):
    ...
    series_data['stats_data'] = get_all_match_detailed_stats(series_data['stats_url'], series_data['num_matches'])
    series_data['performance_data'] = get_all_match_performance(series_data['performance_url'])
